// yucoco cafe (B案) — gallery lightbox (vanilla JS, no deps)
// A案 site/assets/lightbox.js を移植。サムネイルの取得元セレクタのみ B 案マークアップ（.piece）に合わせて変更
(function () {
  ...
  var thumbs = Array.prototype.slice.call(document.querySelectorAll('.piece img[data-full]'));
